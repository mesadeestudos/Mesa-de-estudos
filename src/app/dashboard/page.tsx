...
// Consolidamos todos os tópicos em uma lista plana para busca
  ...
  return (
    ...
    {/* Card de Foco do Dia - Ocupa 9 colunas (3 das disciplinas + 6 do cronômetro) */}
    <div className="col-span-12 lg:col-span-9 bg-gradient-to-br from-[#082040] to-[#164F73] p-8 rounded-[40px] text-white flex flex-col md:flex-row justify-between items-center shadow-2xl relative overflow-hidden group">
