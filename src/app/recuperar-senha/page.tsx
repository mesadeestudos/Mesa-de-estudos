    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-10">
          <Link href="/">
            <img src="/logo_azul.png" alt="Mesa de Estudos" className="h-50 w-auto mx-auto mb-6" />
          </Link>
        ...
        <div className="bg-white/80 backdrop-blur-2xl p-8 rounded-[32px] border border-slate-100 shadow-[0_32px_64px_-15px_rgba(0,0,0,0.05)]">
          {!isSent ? (
            <form onSubmit={handleRecover} className="space-y-6">
              <div>
                <label className="block text-xs font-black text-slate-400 uppercase tracking-[0.2em] mb-2 ml-1">E-mail de cadastro</label>
                <input 
                  required
                  type="email" 
                  value={email}
            ...
            <div className="text-center py-4">
              ...
              <p className="text-slate-600 font-bold mb-6">Enviamos as instruções para <strong>{email}</strong></p>
