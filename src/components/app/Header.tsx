...
export default function Header({ title, eyebrow = 'Mesa de Estudos', actions, onMenuClick }: HeaderProps) {
  return (
    <header className="app-header mb-6 flex shrink-0 items-center justify-between rounded-[28px] border border-white/70 bg-white/75 px-4 py-3 shadow-xl shadow-slate-200/50 backdrop-blur-xl lg:px-5">
